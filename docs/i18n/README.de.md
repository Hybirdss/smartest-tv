...
<p align="center"><sub>Kein TV? Öffnet im Browser. TV vorhanden? <code>stv setup</code> zum Verbinden.</sub></p>
...
<p align="center">
  <sub>MIT License · Mit Python erstellt · Keine Cloud erforderlich</sub>
</p>
